    ...
    $(function() {
        ...
        if ($.datepicker != null) {
            (function() {
                ...
                dateTimeElems.each(function(index, elem){
                    if ($(elem).attr('name').indexOf('end_date') >= 0) {
                        timeStr = "' 11:59 PM'";
                    } else {
                        timeStr = "' 01:01 AM'";
                    }
        ...
        // report tables
        $('.store_report_table th a').click(function(e) {
            e.stopPropagation();
        });
        $('.store_report_table th').click(function() {
