...
class FieldTypeManager
{
	...
	function __construct($ee, $filter) {
		$this->EE = $ee;
		$this->_prefix = 'blocks';
		$this->_filter = $filter;
	}
	...
	private function buildFieldTypeArray()
	{
		...
		$fieldtypeArray = $this->callDiscoverFieldtypesHook($fieldtypeArray);
	...
	private function callDiscoverFieldtypesHook($fieldtypeArray)
	{
		if ($this->EE->extensions->active_hook('blocks_discover_fieldtypes') === TRUE)
		{
