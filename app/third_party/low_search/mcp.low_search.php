...
class Low_search_mcp extends Low_search_base {
	...
	public function settings()
	{
		...
		$this->data['filters'] = ee()->low_search_filters->names();
	...
	public function edit_collection()
	{
		...
		// --------------------------------------
		// Get languages from config array
		// @todo: change this to proper locales
		// --------------------------------------
	...
	public function export_search_log()
	{
		...
		$query = ee()->db->select(array(
				"{$t}.parameters", "{$t}.keywords", "{$t}.num_results", 'members.screen_name AS member',
	...
	public function build()
	{
		...
		$col_id  = ee()->input->post('collection_id');
		$start   = ee()->input->post('start');
