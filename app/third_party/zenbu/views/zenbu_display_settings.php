...
<div class="clear"></div>
	...
	<div class="ch_tables nav_ch_<?=$channel['id']?>">
		<br />
		<button class="collapsetoggle right" type="button"><span><?=lang('collapse_unshown')?></span><span class="invisible"><?=lang('expand_unshown')?></span></button>
			...
			<?php foreach($setting_labels[$channel["id"]] as $order) :?>
				...
				<?php foreach($order as $setting_label) :?>
					...
					<tr class="<?=$row_class?>">
						...
						<td class="hoverable center clickable not-sortable display">
							<?php $selected = '';?>
	...
	<div class="collapsedrows invisible"></div>
