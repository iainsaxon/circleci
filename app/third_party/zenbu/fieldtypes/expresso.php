...
*	============================================
*	PutYourLightsOn's Expresso field
*	@author	PutYourLightsOn http://www.putyourlightson.net/
*	@link	http://www.putyourlightson.net/projects/expresso
*	============================================
*	File expresso.php
*
*/

class Zenbu_expresso_ft extends Expresso_ft
{
	/**
	*	Constructor
	*
	...
	*/
	function zenbu_field_extra_settings($table_col, $channel_id, $extra_options)
	{
		...
		$output['text_option_1'] = form_label($this->EE->lang->line('show').NBS.form_input('settings['.$channel_id.']['.$table_col.'][text_option_1]', $extra_text_option_1, 'size="2" maxlength="4" class="bottom-margin"').'&nbsp;'.$this->EE->lang->line('characters')).'<br /><br />';
...
/* End of file expresso.php */
/* Location: ./system/expressionengine/third_party/zenbu/fieldtypes/expresso.php */
?>