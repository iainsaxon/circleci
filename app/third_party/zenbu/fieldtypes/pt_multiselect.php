...
*	============================================
*	Pixel&Tonic's PT Multiselect field
*	@author	Pixel&tonic http://pixelandtonic.com
*	@link	http://pixelandtonic.com/divebar
*	============================================
*	File pt_multiselect.php
*
*/

class Zenbu_pt_multiselect_ft extends Pt_multiselect_ft
{
	...
	*/
	function __construct()
	{
		...
		$this->zenbu_class = new Zenbu_fieldpack_select_fields();
	}
...
/* End of file pt_multiselect.php */
/* Location: ./system/expressionengine/third_party/zenbu/fieldtypes/pt_multiselect.php */
?>