...
*	============================================
*	Pixel&Tonic's Field Pack Radio buttons field
*	@author	Pixel&tonic http://pixelandtonic.com
*	@link	http://pixelandtonic.com/ee
*	============================================
*	File fieldpack_radio_buttons.php
*
*/

class Zenbu_fieldpack_radio_buttons_ft extends Fieldpack_radio_buttons_ft
{
	...
	*/
	function __construct()
	{
		...
		$filename = 'single_option_fields.php';
		...
		$this->zenbu_class = new Zenbu_fieldpack_single_option_fields();
	}
...
/* End of file fieldpack_radio_buttons.php */
/* Location: ./system/expressionengine/third_party/zenbu/fieldtypes/fieldpack_radio_buttons.php */
?>