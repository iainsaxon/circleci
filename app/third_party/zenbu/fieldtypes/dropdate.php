...
*	============================================
*	Dropdate field
*	@author	Stephen Lewis - Experience Internet http://experienceinternet.co.uk/
*	@link	http://experienceinternet.co.uk/software/dropdate/docs/
*	@link	http://devot-ee.com/add-ons/dropdate
*	============================================
*	File dropdate.php
*
*/

class Zenbu_dropdate_ft extends Dropdate_ft
{
	...
	*/
	function zenbu_result_query($rules = array(), $field_id = "", $fieldtypes, $already_queried = FALSE)
	{
		foreach($rules as $rule)
		{
			...
			if(isset($rule['field']) && $r_field_id == $field_id && $fieldtypes['fieldtype'][$r_field_id] == 'dropdate')
			{
...
/* End of file dropdate.php */
/* Location: ./system/expressionengine/third_party/zenbu/fieldtypes/dropdate.php */
?>